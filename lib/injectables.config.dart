...
import 'src/application/auth/auth_bloc.dart' as _i10;
...
import 'src/infrastructure/auth/auth_facade_impl.dart' as _i9;
...
import 'src/presentation/core/router/router.dart' as _i3;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i8.IAuthFacade>(() => _i9.AuthFacadeImpl(
        googleSingIn: gh<_i6.IGoogleSignInDataService>(),
        auth: gh<_i4.IAuthDataService>(),
      ));
  gh.factory<_i10.AuthBloc>(() => _i10.AuthBloc(gh<_i8.IAuthFacade>()));
  return getIt;
}
