...
class __$$_StartedCopyWithImpl<$Res>
    extends _$GoogleSignInEventCopyWithImpl<$Res, _$_Started>
...
abstract class _Started implements GoogleSignInEvent {
...
class _$_GoogleSignInState implements _GoogleSignInState {
  const _$_GoogleSignInState({required this.isUser});
  ...
  @override
  String toString() {
    return 'GoogleSignInState(isUser: $isUser)';
  }
...
abstract class _GoogleSignInState implements GoogleSignInState {
  const factory _GoogleSignInState({required final bool isUser}) =
      _$_GoogleSignInState;
